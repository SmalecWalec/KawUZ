INSERT INTO product (name, description, product_available, stock_quantity, price) VALUES
('Ethiopian Yirgacheffe', 'Jasno palone ziarna kawy o nutach kwiatowych i cytrusowych', TRUE, 50, 18.99),
